...
const addTrackToPlaylist = (trackId, playlistId) => { // input is the trackId and the playlist it's adding to
...
const addTrack = (name, artist, album) => {
  const accessTracks = library.tracks;
...
addTrack("Test", "TestArtist", "TestAlbum");
// printTracks(library);
// console.log(library);

// // adds a playlist to the library
const addPlaylist = (name) => {
  const accessPlaylists = library.playlists;
